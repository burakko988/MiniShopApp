...
namespace MiniShopApp.WebUI.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        private Payment PaymentProcess(OrderModel orderModel)
        {
            ...
            options.ApiKey = "sandbox-9D01souNiet8ejdsclkhltHUrSaItC74";//Bu kısıma iyzipay developer modda olusturdugunuz hesaptaki apikeyi giriniz
            options.SecretKey = "sandbox-8q72kkhu9mmEtYr1od2cZcomxvZWttH8"; //Bu kısıma iyzipay developer modda olusturdugunuz hesaptaki SecretKey giriniz
